...
<body>
    ...
    <span class="span-détails" style="text-align: center;">Réalisé par T.Pastor & B.Bayche <br>Si les données ne s'affichent pas, c'est car le host à une limite de requêtes(500), patientez juste quelques minutes.</span>
</body>
